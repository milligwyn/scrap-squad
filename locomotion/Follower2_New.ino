...
// which follower it is talking to.
//
...
// PIN ASSIGNMENTS
// -----------------------------------------------------------------------------
//   enca[0]=14, encb[0]=15  — Encoder A/B channels for motor 0 (rear-left)
//   enca[1]=16, encb[1]=17  — Encoder A/B channels for motor 1 (rear-right)
...
// the rear-wheel follower specifically. Follower 1 uses address 1.
